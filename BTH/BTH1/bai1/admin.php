                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($flower['image'])): ?>
                            <img src="<?php echo $flower['image']; ?>" alt="<?php echo htmlspecialchars($flower['name']); ?>" width="100">
                        <?php endif; ?>
                    </td>
                    <td>
                        <button onclick="editFlower(<?php echo $index; ?>)">Sửa</button>
                        <a href="admin.php?delete=<?php echo $index; ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?');">Xóa</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
